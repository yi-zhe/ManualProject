...
var app = getApp();
var constant = require('../../../common/js/calendar/constant.js');
var taskService = require('../../../common/js/calendar/service').taskService;
var wxService = require('../../../common/js/calendar/wx.js');
var us = require('../../../lib/underscore');
var moment = require('../../../lib/moment.js');
var utils = require('../../../utils/utils');
var calendar = require('../../../utils/calendar/utils').calendar;
var _fn;
...
_fn = {
    ...
    goUpdateTask: function (key) {
        wx.navigateTo({//youbug
            url: './create?pageType=update&key=' + key
        });
    }
