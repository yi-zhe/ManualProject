var _fn,
    taskService = require('../../../common/js/calendar/service').taskService,
    dateService = require('../../../common/js/calendar/service').dateService,
    moment = require('../../../lib/moment.js'),
    us = require('../../../lib/underscore'),
    utils = require('../../../utils/calendar/utils'),
    app = getApp();
Page({
    data: {},
